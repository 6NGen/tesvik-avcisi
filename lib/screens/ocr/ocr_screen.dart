          ...
          children: [
            const SizedBox(
              ...
              child: CircularProgressIndicator(
                  color: AppTheme.ormanYesili, strokeWidth: 3),
            ),
            const SizedBox(height: 24),
            const Text('🧠 Yapay zeka analiz ediyor...',
                style: TextStyle(
                    fontSize: 16, fontWeight: FontWeight.w600, color: AppTheme.ormanYesili)),
            const SizedBox(height: 8),
            if (state.dosyaAdi != null)
              Text(state.dosyaAdi!, style: const TextStyle(fontSize: 13, color: AppTheme.gri)),
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Profilin belgeye göre otomatik güncellendi.',
                      style: TextStyle(
              ...
              child: ClipRRect(
                ...
                child: Markdown(
                  ...
                  styleSheet: MarkdownStyleSheet(
                    p: const TextStyle(fontSize: 14, height: 1.6, color: AppTheme.koyu),
                    h2: const TextStyle(
                        fontSize: 16, fontWeight: FontWeight.w800, color: AppTheme.ormanYesili),
                    a: const TextStyle(
                        color: Colors.blue,
          ...
          child: Column(
            ...
            children: [
              ...
              Text(state.hata!,
                  ...
                  style: const TextStyle(color: AppTheme.hata, fontSize: 14)),
              const SizedBox(height: 24),
              ElevatedButton.icon(
                onPressed: notifier.dosyaSecVeAnalizeEt,
                icon: const Icon(Icons.refresh_rounded),
        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                children: [
                  Container(
                    width: 80, height: 80,
                    decoration: BoxDecoration(
                        color: AppTheme.yaprakAcik, shape: BoxShape.circle),
                    child: const Center(
                        child: Text('📄', style: TextStyle(fontSize: 38))),
                  ),
                  const SizedBox(height: 20),
                  const Text('Belgenizi Yükleyin',
                      style: TextStyle(
                          fontSize: 20, fontWeight: FontWeight.w800, color: AppTheme.koyu)),
                  const SizedBox(height: 8),
                  const Text(
                    'ÇKS belgesi veya teşvik belgelerinizi\nyükleyin, AI analiz etsin.',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 13, color: AppTheme.gri, height: 1.5),
                  ),
                  const SizedBox(height: 24),
                  ElevatedButton.icon(
                    onPressed: notifier.dosyaSecVeAnalizeEt,
                  ...
                  const Text('PDF • JPG • PNG',
                      style: TextStyle(
                          fontSize: 12, color: AppTheme.gri, letterSpacing: 1)),
                ],
              ),
            ),
            const SizedBox(height: 20),
            Container(
              ...
              decoration: BoxDecoration(
                  color: AppTheme.altinAcik, borderRadius: BorderRadius.circular(12)),
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'e-Devlet\'ten indirdiğiniz ÇKS PDF belgesini doğrudan yükleyebilirsiniz.',
                      style: TextStyle(fontSize: 12, color: AppTheme.toprakKahve),
                    ),
                  ),
                ],
              ),
